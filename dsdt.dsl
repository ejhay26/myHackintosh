...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x87F75698, 0x0635)
    ...
    OperationRegion (OGNS, SystemMemory, 0x87F74F98, 0x0000000C)
                ...
                Device (HS04)
                {
                    ...
                    Device (CAM4)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            Return (PLXX) /* \_SB_.PCI0.XHC_.RHUB.HS04.CAM4._PLD.PLXX */
                        }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
            ...
            Scope (\)
            {
                OperationRegion (LFCN, SystemMemory, 0x87F7DD98, 0x00E7)
    ...
    OperationRegion (MDBG, SystemMemory, 0x87F5E018, 0x00001004)
